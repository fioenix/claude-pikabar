"""pikabar CLI — install/uninstall commands for Claude Code integration.
...
def main():
    """CLI entry point: install | uninstall | (default: statusline renderer)."""
    if len(sys.argv) > 1:
        ...
        if cmd == "install":
            ...
            print("Usage: pikabar [install|uninstall|--version]")
            sys.exit(1)
    else:
